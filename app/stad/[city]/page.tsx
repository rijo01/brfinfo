...
const META: Record<string, { name: string; count: number; desc: string; areas: string[] }> = {
  ...
  vasteras: { name: 'Västerås', count: 698, desc: 'BRF:er i Västerås – 698 registrerade bostadsrättsföreningar. Jämför avgifter och hitta styrelseinfo direkt.', areas: ['Centrum', 'Hamre', 'Skallberget', 'Viksäng', 'Bäckby', 'Rönnby', 'Tillberga', 'Irsta'] },
